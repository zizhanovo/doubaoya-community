...
| 技能 | 一句话 |
|------|--------|
| **dby-write** | 写作主干：读你的号章程与创作 DNA，选题 → 定标题 → 提纲 → 正文 → 摘要留言 → 自检，一口气写完一篇像你写的文章；也管**复盘**（按你自己的历史均值分四象限，只告诉你该修哪一处） |
...
| 技能 | 一句话 |
|------|--------|
| **dby-image** | AI 生图与改图：一句话要一张图——文生图 / 图生图 / 改图 / 主视觉 / 单独配一张插图。慢操作（1–4 分钟），出图后落成本地文件给你路径 |
