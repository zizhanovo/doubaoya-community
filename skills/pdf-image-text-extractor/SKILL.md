...
description: 从图片或 PDF 文档中识别并提取文字内容，支持多种图片格式和 PDF 文件，自动判断是否包含文字并保留原始格式输出结构化结果；当用户需要 PDF提取、PDF文字、图片文字、OCR 识别、文档提取、提取文本、处理扫描件或将含文字的文档转换为可编辑文本时使用。触发词：PDF提取、PDF文字、图片文字、OCR识别、文档提取、提取文本、扫描件。
dependency:
  python:
    - pymupdf>=1.23.0
compatibility: >-
