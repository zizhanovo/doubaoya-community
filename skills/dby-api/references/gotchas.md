...
- ⚠️ **趋势雷达是「已有话题」那一档，而且它不是榜。** `skill.trend.radar`（与同底座的
  `skill.social.last30Days`）**按关键词搜三个平台的文章**：手里已经有词、要看它在各平台分别被谁
  怎么写时用它们（雷达在生产上是第二活跃的能力）。keyword **必填**——2026-09-08 之前不传会
  悄悄退化成搜「热点」二字并照常扣点，现在直接 400。
  **没有话题、指望它给你想选题**时不该用：它排不出「今天什么在热」，那种需求走
