...
零依赖（Python 3 标准库 urllib），按日期 + 分类拉小红书日榜爆文，
供主 Agent 看当天哪些笔记最火。

用法:
    python3 fetch_daily_top.py [--rank-date YYYY-MM-DD] [--category 综合]
...
ENDPOINT = "https://doubaoya.com/api/apis/xiaohongshu/xiaohongshu-daily-top/call"
