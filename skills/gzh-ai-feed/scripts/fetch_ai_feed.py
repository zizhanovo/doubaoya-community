...
零依赖（Python 3 标准库 urllib），按关键词扫描 AI 方向的
公众号爆款文章，用于做每日 AI 选题日报。

用法:
    python3 fetch_ai_feed.py "<关键词>" [--page N] [--size N]
...
ENDPOINT = "https://doubaoya.com/api/apis/gongzhonghao/gongzhonghao-ai-feed/call"


def main() -> int:
    parser = argparse.ArgumentParser(
        description="都爆鸭 · AI 公众号日报内容源（按关键词）",
    )
    parser.add_argument(
        "keyword",
        help="AI 方向关键词（必填，如 AI / 大模型 / AI Agent / RAG）",
    )
    parser.add_argument(
        "--page",
        type=int,
