---
name: gzh-ai-feed
description: AI 公众号日报内容源 · 按关键词扫描 AI 方向的公众号爆款，终端表格展示（标题链接/点赞）并聚类成每日选题日报。当用户需要 AI 日报、每日 AI 热点、AI 公众号爆款、AI 内容选题、做 AI 赛道内容发现时使用。触发词：每日榜、公众号爆文、热点扫描、选题素材、内容灵感。
---
