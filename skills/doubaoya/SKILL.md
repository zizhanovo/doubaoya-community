...
name: doubaoya
description: >-
  都爆鸭 (doubaoya / 本鸭) — 新媒体取数与创作总入口：一条 DOUBAOYA_API_KEY
  调平台全部在架能力（搜索/榜单/日报源/账号/解析/违禁词/生图/联网查证），按意图路由到具体能力。也包括**要带出处的联网查资料 / 事实核查**。Trigger words:
  改图、过审、追更、配图、主视觉、图生图、增长榜、扒文章、文生图、极限词、查出处、每日榜、热点榜、看评论、起标题、追流量、一周爆款、中线选题、事实核查、今日热点、今日爆款、低粉爆款、低粉高赞、作品详情、全网热搜、内容出海、内容创作、内容灵感、写小红书、出海日报、出海爆款、出海选题、合规检测、周度趋势、头部账号、实时取数、对标作品、对标分析、封面参考、封面套路、封面灵感、封面设计、封面选题、小号打法、引用来源、扒评论区、抖音取数、抖音搜索、抖音评论、持续走高、最多点赞、最新发布、标题优化、标题套路、标题灵感、标题生成、流量风向、热度指数、热点扫描、热门文章、热门账号、爆款仿写、爆款复盘、爆款封面、爆款排行、爆款文章、爆款标题、爆款结构、生成图片、用户需求、盯公众号、社媒舆情、竞品跟踪、笔记对标、笔记拆解、笔记生成、笔记选题、素人爆款、联网搜索、联网查证、聚合热榜、舆情监测、解析链接、评论分析、评论风向、话题研究、豆包搜索、近期爆款、选题拆解、选题灵感、选题素材、选题角度、链接解析、阅读增长、首图灵感、黑马笔记、黑马账号、AI
  出图、全平台爆款、公众号写作、公众号取数、公众号封面、公众号排行、公众号标题、公众号榜单、公众号爆文、公众号爬虫、公众号黑马、冷启动对标、增长率排行、对标后再写、小红书作品、小红书创作、小红书周榜、小红书封面、小红书排行、小红书搜索、小红书日榜、小红书标题、小红书榜单、小红书热榜、小红书爬取、小红书选题、扒抖音作品、找对标笔记、搜抖音爆款、热搜关键词、短视频选题、视频号日报、视频号爆款、视频号选题、订阅公众号、跨平台分析、跨平台热搜、跨平台选题、高点击标题、AI
  视频号、公众号违禁词、出海流量风口、小红书周排行、批量爬公众号、抖音实时搜索、抖音综合搜索、照着写小红书、爆款笔记发现、竞品发文复盘、视频号 AI、账号发文列表、近30天作品、小红书
  TOP、小红书热门笔记、小红书爆款笔记、小红书笔记查询、热榜TOP10、看赛道热门内容、小红书抖音公众号、某公众号发了什么
compatibility: >-
