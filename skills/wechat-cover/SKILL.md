---
name: wechat-cover
description: 公众号爆款封面与标题参考 · 按主题关键词拉同赛道爆款的封面图 + 标题 + 点击量，帮你提炼可复用的封面视觉套路（配色/构图/信息层级）和标题套路。当用户需要公众号封面参考、爆款封面、封面设计灵感、封面配色构图、封面套路总结，或要起公众号标题、优化标题、找同赛道高点击标题参考时使用。触发词：公众号封面、爆款封面、封面参考、封面设计、封面套路、封面灵感、公众号标题、起标题、标题套路、爆款标题、标题优化、高点击标题。
---
...
本 skill 给的是**同赛道封面的视觉套路**（配色 / 构图 / 文字排布），**不产出封面图文件本身**。
用户要的终态决定这里是不是终点——**别默认往下推**：

| 用户要的终态 | 到这一步够不够 | 下一步 |
|---|---|---|
| 只要封面思路 / 自己去做图 | ✅ 够了，**到这里就结束** | — |
