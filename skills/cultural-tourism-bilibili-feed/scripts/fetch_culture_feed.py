...
零依赖（Python 3 标准库 urllib），按关键词扫描 B 站上的
文旅 / 城市 / 景区方向爆款视频，用于做文旅选题与对标。
...
ENDPOINT = "https://doubaoya.com/api/apis/bilibili/bilibili-playlet-feed/call"


def main() -> int:
    parser = argparse.ArgumentParser(
        description="都爆鸭 · B站文旅视频内容源（按关键词）",
    )
    parser.add_argument(
        "keyword",
