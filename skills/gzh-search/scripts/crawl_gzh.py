...
零依赖（Python 3 标准库 urllib），按关键词批量爬取微信公众号文章，
打 JSON 到 stdout，由主 Agent 铺成「标题/作者/发布时间」终端表格做选题洞察。

用法:
    python3 crawl_gzh.py "<关键词>" [--page N]
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="都爆鸭 · 公众号搜索爬虫（按关键词批量取数）",
    )
