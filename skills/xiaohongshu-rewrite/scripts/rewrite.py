...
# -*- coding: utf-8 -*-
"""
xiaohongshu-rewrite/scripts/rewrite.py

小红书文案改写辅助脚本（本地运行，零网络调用）
用途：从 assets/platform-rules.md 提取小红书改写规则 prompt

说明：
  - 纯本地脚本，仅使用 Python 标准库（os、re、sys）
  - 不发起任何网络请求，无需 API Key，不上报任何数据
...
说明：
  纯本地脚本，仅使用 Python 标准库，不发起任何网络请求，无需 API Key。
""")
